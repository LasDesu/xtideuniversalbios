...
%elifdef MODULE_PRAKTIK_IDE
	at	ROMVARS.ideVars0+IDEVARS.wBasePort,				dw	PRIDE_BIOS_SEGMENT_ADDRESS		; Controller Command Block base port
	at	ROMVARS.ideVars0+IDEVARS.bDevice,				db	DEVICE_8BIT_PRAKTIK
%else
	at	ROMVARS.ideVars0+IDEVARS.wBasePort,				dw	DEVICE_XTIDE_DEFAULT_PORT		; Controller Command Block base port
